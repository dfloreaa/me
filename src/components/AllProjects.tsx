        ...
        <div className="projects-container" id="all-projects">
            ...
            <div className="blog-content">
                ...
                <div className="project-story">
                    ...
                    <div className="image-embed float-right all-projects">
                        <img src={ikeaRobot} alt="Custom robot control dashboard" className="story-image" />
                ...
                <div className="project-story">
                    ...
                    <div className="image-embed float-right all-projects">
                        <div className="side-by-side-images">
                            <img src={tspGIF} alt="Autonomous TSP Forklift in operation" className="story-image" />
                            <img src={tspCrown} alt="Crown TSP 6500 forklift" className="story-image" />
                        </div>
                ...
                <div className="project-story">
                    ...
                    <div className="image-embed float-right all-projects">
                        <img src={tamuCar} alt="Custom robot control dashboard" className="story-image" />
                ...
                <div className="project-story">
                    ...
                    <div className="image-embed float-right all-projects">
                        <div className="side-by-side-images">
                            <img src={jlgGIF} alt="Autonomous JLG stock picker in operation" className="story-image" />
                            <img src={jlgMSP} alt="JLG 10MSP forklift" className="story-image" />
                        </div>
                        <p className="image-caption">
                ...
                <div className="project-story">
                    ...
                    <div className="image-embed float-right all-projects">
                        <img src={capstoneGIF} alt="SCARA robotic arm in operation" className="story-image" />
                        <p className="image-caption">
                ...
                <div className="project-story">
                    ...
                    <div className="image-embed float-right all-projects">
                        <img src={caleuche} alt="Caleuche autonomous catamaran" className="story-image" />
                        <p className="image-caption">
